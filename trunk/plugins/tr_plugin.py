...
register_command_handler(translit_table, 'tr_table', ['все'], 0, 'Таблица транслита', 'tr_table', ['tr_table'])
register_command_handler(from_translit_eng, 'tr', ['все'], 0, 'Перевод с транслита в англ.', 'tr <text>', ['tr privet'])
