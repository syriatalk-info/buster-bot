...
register_command_handler(handler_weather_pogoda, 'погода', ['инфо','все'], 0, 'Показывает погоду с ресурса gismeteo.ru, для всех стран мира \nНаписал: Avinar', 'погода <город_русскими_буквами>', ['погода Новосибирск','погода париж','погода ростов-на-дону'])	
