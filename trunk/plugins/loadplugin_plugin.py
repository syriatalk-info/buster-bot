  ...
  for x in i:
    for y in COMMAND_HANDLERS.keys():
      ...
      if hasattr(COMMAND_HANDLERS[y], 'func_name') and COMMAND_HANDLERS[y].func_name==x.strip():
        ...
        if y in COMMANDS,keys(): del COMMANDS[y]
...
register_command_handler(svn_update_plugin, 'обновиплаг', ['все'], 99, 'Обновляет плаг с свн', 'обновиплаг <plugin>', ['обновиплаг ibb_plugin.py','обновиплаг admin.py'])
