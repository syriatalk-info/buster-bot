...
register_command_handler(handler_python_eval, 'eval', ['суперадмин','все'], 0, 'Расчитывает и показывает заданное выражение питона.', 'eval <выражение>', ['eval 1+1'])
register_command_handler(handler_python_exec, 'exec', ['суперадмин','все'], 0, 'Выполняет выражение питона.', 'exec <выражение>', ['eval pass'])
