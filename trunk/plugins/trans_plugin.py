...
register_command_handler(yatr_hnd, 'yat', ['инфо','все'], 0, 'Перевод с одного языка на другой с автоопределением. Используется Yandex Translate.', 'yat <текст>', ['yat hello', 'yat привет'])       
