                ...
                if mtype == "error":
                        ...
                        if code == '500' and hasattr(el, 'body'):
                                ...
                                try:
                                        ...
                                        #reactor.callFromThread(dd, stanza, CLIENTS[self.jabberid])
...
def reply(type, source, body):
        ...
        if body2: threading.Thread(None,reply,'reply_part_2'+str(INFO['thr']),(('private' if type in ['public','groupchat'] else type),source,body2)).start()
