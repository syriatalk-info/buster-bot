...
def handler_help_help(type, source, parameters):
	...
	rep = str()
	if not parameters:
                rep = u'Я бот - Бастер(болван), созданный для игры <<Мафия>>, а также с поддержкой многих пользовательских функций для ростера и конференций.\n'
                ...
                rep += u'Бот использует twisted framework, написан на Python.'
