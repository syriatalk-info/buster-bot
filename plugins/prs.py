...
register_command_handler(hnd_set_restart, 'авторестарт', ['все'], 100, 'Задаеt время в часах через которое будет выполняться авторестарт бота. 0 для отключения', 'авторестарт <часы>', ['авторестарт 24'])
